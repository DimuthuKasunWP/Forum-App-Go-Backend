...
func TestCreateUser(t *testing.T) {
	...
	samples := []struct {
		...
		{
			inputJSON:  `{"username":"dimuthu", "email": "pet@example.com", "password": "password"}`,
			statusCode: 500,
		},
		{
			inputJSON:  `{"username":"Pet", "email": "kasun@example.com", "password": "password"}`,
			statusCode: 500,
		},
		{
			inputJSON:  `{"username":"pathirana", "email": "pathiranaexample.com", "password": "password"}`,
			statusCode: 422,
		},
		{
			inputJSON:  `{"username": "", "email": "kasun@example.com", "password": "password"}`,
			statusCode: 422,
		},
		{
			inputJSON:  `{"username": "kasun", "email": "", "password": "password"}`,
			statusCode: 422,
		},
		{
			inputJSON:  `{"username": "kasun", "email": "kasun@example.com", "password": ""}`,
			statusCode: 422,
		},
	}
